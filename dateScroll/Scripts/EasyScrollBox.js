...
(function ($) {
    ...
    EasyScrollBox.prototype.buildHtml = function (target) {
        ...
        _body += '</ul>';
        _body += '</div>';
        _body += '<div id="cover_top_EasyScrollBox" style="height: ' + theight + 'px; background-color: #fff; width: 100%; margin-top: ' + bttop + 'px; z-index: 3;opacity:0.6;pointer-events:none;-ms-touch-action:none;"></div>';
        _body += '<div id="cover_bottom_EasyScrollBox" style="height: ' + bheight + 'px; background-color: #fff; width: 100%; margin-top: ' + bmtop + 'px; z-index: 3;opacity:0.6;pointer-events:none;-ms-touch-action:none;"></div>';
        _body += '</div>';
        target.html(_body);
        var _h = iheight;
        var u = document.getElementById(idul);
