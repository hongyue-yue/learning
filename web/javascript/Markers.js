...
function onTourLoad(data){
	...
	editor.cur_sphere = new ERViewer('sphere_canvas',10,10,sphere_size*4,sphere_size*2);
	editor.prev_sphere = new ERViewer('sphere_canvas',0,sphere_size*2+20,sphere_size*2,sphere_size);
	editor.next_sphere = new ERViewer('sphere_canvas',sphere_size*2 + 20,sphere_size*2+20,sphere_size*2,sphere_size);
	...
	door_editor.main_sphere = new ERViewer('door_canvas',20,0,ds_width,ds_height);
	door_editor.join_sphere = new ERViewer('door_canvas',40+ds_width,0,ds_width,ds_height);
