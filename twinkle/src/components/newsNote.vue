...
<style>
#note{z-index:20;width:500px;height:700px;position:relative;}
#note .note_top{width:100%;height:50px;background-color: #eee67d;position: absolute;}
#note .note_top img{margin:10px 0 0 10px;}

#note .note_middle{width:100%;height:600px;position:absolute;top:50px;overflow:scroll;
             background-color: #edecea;}
#note .note_middle::-webkit-scrollbar {display:none}

#note .note_edit{position:absolute;bottom:0;width:100%;height:50px;}
#note .in1{width:350px;height:30px;font-size:20px;position:absolute;top:10px;left:50px;
           border-radius: 8px;border:1px solid #cacdd0 }
#note .in2{width:60px;height:30px;position:absolute;top:12px;right:15px;}
</style>
